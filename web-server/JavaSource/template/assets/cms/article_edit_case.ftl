...
<script type="text/javascript">
    $(function () {
        var images = <@s.property value="@com.fantasy.framework.util.jackson.JSON@serialize(art.images)" escapeHtml="false" default="[]"/>;
        var imageUploader = $('#imageUploader').upload({data:{'dir':'cms_image'},theme:'images',size:'160x160'},images);
        $("#saveForm").ajaxForm({
    ...
    <@s.form id="saveForm" namespace="/cms/article" action="article_save" method="post" cssClass="center-margin">
        ...
        <div class="col-md-6 pad10T">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-9">
                    <div class="append-left">
                        <@s.textfield name="style" value="%{art.style}"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6  pad10T">
            <div class="form-row">
                ...
                <div class="form-input col-md-9">
                    <div class="append-left">
                        <@s.textfield name="square" value="%{art.square}"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-9 ">
                    <div class="append-left">
                        <@s.textfield name="designer" value="%{art.designer}"/>
                    </div>
                </div>
            </div>
        </div>
