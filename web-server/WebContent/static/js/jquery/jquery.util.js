            ...
            view.on('add', function (data) {
                ...
                this.target.find('.up').click(function (e) {
                    ...
                    if (_index == 0) {
                        ...
                        var callback = Fantasy.proxy(function () {
                        ...
                        if (view.fireEvent('move', view, ['up', zhis, view.get(_index - 1),callback]) != false) {
                            callback();
                        }
                    }
                    return stopDefault(e);
                ...
                this.target.find('.down').click(function (e) {
                    ...
                    if (_index == (view.size() - 1)) {
                        ...
                        if (view.fireEvent('move', view, ['down', zhis, view.get(_index + 1),callback]) != false) {
                            callback();
                        }
                    }
                    return stopDefault(e);
